...
var regioesLv = texto.substr(955,88);
alert(regioesLv);
...
// O nome dos pontos turísticos localizados no bairro Centro da cidade de São Paulo.455
var centroSp = texto.substr(447,67);
alert(centroSp);

// O nome dos pontos turísticos localizados no bairro Downtown na cidade de Los Angeles.
var pontosDowntown= texto.substr(1054,95);
